...
<div class="cart_wrapper">
  ...
  <div class="cart__selectors">
    <input type="checkbox" id="selectAll"><label for="selectAll">Выбрать всё</label>
    <span class="cart__deleteSlected"
...
export default {
  ...
  computed: {
    products() {
      console.log('this.$store.state.resultCart: ', this.$store.state.resultCart);
